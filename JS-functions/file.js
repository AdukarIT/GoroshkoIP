...
function insecond(x, y, z) {
    if (x < 0 || y < 0 || z < 0)
        return "error";
    return x * 86400 + y * 3600 + z * 60;
}
if (x >= 0 && y >= 0 && z >= 0)
    console.log("В секундах:");
console.log(insecond(x, y, z)); */
...
/* let a = +prompt("Введите коэффициент квадратного уравнения a:");
let b = +prompt("Введите коэффициент квадратного уравнения b:");
let c = +prompt("Введите коэффициент квадратного уравнения c:");
